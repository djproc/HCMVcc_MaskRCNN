# HCMV cell classification MaskRCNN
This is a Tensorflow 2.0 implementation of Mask RCNN adapted to run on whole coverslip scanning microscopy datasets to identify HCMV infected cells. 

Originally generated by waleedka and adapted to Tensorflow 2.0 by Tom Gross and others.

Files for HCMV identification can be found in the folder "samples/HCMV" 

It will definitely be easier to run this using docker 
